...
#define EEPROM_LUCIEBOX_POWER_CYCLE_COUNTER             EEPROM_SETTINGS_OFFSET + 1
...
#define EEPROM_MULTITIMER_TOTAL_LENGTH                  11  // 11 bytes timers count, timers init time, fischer time

#define EEPROM_SEQUENCER_SONGS_START_ADDRESS            EEPROM_MULTITIMER_START_ADDRESS + EEPROM_MULTITIMER_TOTAL_LENGTH
